...
export const createIndividualRegistrationSchema = z.object({
  customPlayerName: z.string().min(2, "Nome deve ter pelo menos 2 caracteres.").optional(),
});
export type CreateIndividualRegistrationInput = z.infer<typeof createIndividualRegistrationSchema>;
...
export const createTeamRegistrationSchema = z.object({
  ...
  customOwnerName: z.string().min(2, "Nome deve ter pelo menos 2 caracteres.").optional(),
});

#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\conta\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.535\\out\\buildHook\\index.js').default({tool: 'vite', checkSum: '208bd60b9a5cb790758585AExVGANYDFVQAFIHCAcBUA0MXAIP', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/conta/.vscode/extensions/wallabyjs.console-ninja-1.0.535/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '208bd60b9a5cb790758585AExVGANYDFVQAFIHCAcBUA0MXAIP', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
